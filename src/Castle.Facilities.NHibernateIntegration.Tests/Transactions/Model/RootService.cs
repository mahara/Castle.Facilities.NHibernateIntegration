...
namespace Castle.Facilities.NHibernateIntegration.Tests.Transactions
{
    ...
    public class RootService : NHibernateGenericDao
    {
        ...
        [Transaction]
        public virtual void BlogRefOperation_Perform(Blog blog)
        {
        ...
        [Transaction]
        public virtual Blog CreateBlogUsingDetachedCriteriaStateless(string name)
        {
        ...
        [Transaction]
        public virtual void BlogRefOperation_PerformStateless(Blog blog)
        {
            var blogRef = new BlogRef
            {
                ParentBlog = blog,
