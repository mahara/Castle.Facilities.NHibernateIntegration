...
namespace Castle.Facilities.NHibernateIntegration.Builders
{
    ...
    public class PersistentConfigurationBuilder : DefaultConfigurationBuilder
    {
        ...
        private static readonly Regex _invalidCharactersRegex = new(@"[:*?""<>\\/]", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        {
            return _invalidCharactersRegex.Replace(input, string.Empty);
        }
