...
namespace Castle.Facilities.NHibernateIntegration
{
    ...
    /// </list>
    /// <para>
    /// It also allow you to obtain the <see cref="ISession" /> instance through the component <see cref="ISessionManager" />,
    ...
    public class NHibernateFacility : AbstractFacility
    {
        ...
        protected void ConfigureSessionFactory(NHibernateSessionFactoryFacilityConfiguration facilityConfiguration, ISessionFactoryResolver sessionFactoryResolver, bool firstSessionFactory)
        {
            ...
            // Registers the NHibernate Configuration instance.
            Kernel.Register(
    ...
    public class NHibernateSessionFactoryFacilityConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="ISessionFactory" />'s <see cref="IConfigurationBuilder" />.
        /// </summary>
