...
namespace Castle.Facilities.NHibernateIntegration
{
    public class DefaultSessionManager : MarshalByRefObject, ISessionManager
    {
            ...
            bool weAreSessionOwner)
        {
            ...
            const string TransactionContextKey = Constants.Session_TransactionEnlistment_TransactionContextKey;
            ...
            bool weAreSessionOwner)
        {
            ...
            const string TransactionContextKey = Constants.StatelessSession_TransactionEnlistment_TransactionContextKey;
