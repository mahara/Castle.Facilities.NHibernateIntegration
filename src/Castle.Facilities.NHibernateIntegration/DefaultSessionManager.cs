...
namespace Castle.Facilities.NHibernateIntegration
{
    public class DefaultSessionManager : MarshalByRefObject, ISessionManager
    {
        ...
        public ISession OpenSession(string alias)
        {
            ...
            {
                EnlistIfNecessary(transaction, wrappedSession, false);
            ...
            bool weAreSessionOwner)
        {
            ...
            transaction.Context.TryGetValueAs(Constants.Session_TransactionEnlistment_ContextKey,
            ...
            if (shouldEnlist)
            {
                ...
                {
                    transaction.Context[Constants.Session_TransactionEnlistment_ContextKey] = list;
            ...
            bool weAreSessionOwner)
        {
            ...
            transaction.Context.TryGetValueAs(Constants.StatelessSession_TransactionEnlistment_ContextKey,
            ...
            if (shouldEnlist)
            {
                ...
                if (sessionTransaction is null || !sessionTransaction.IsActive)
                {
                    transaction.Context[Constants.StatelessSession_TransactionEnlistment_ContextKey] = list;
