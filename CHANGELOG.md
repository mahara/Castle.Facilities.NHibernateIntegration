...
Breaking Changes:
- Updated **`Castle.Services.Transaction`** to 5.4.0.
- Updated **`Castle.Facilities.AutoTx`** to 5.4.0.
- Updated **`NHibernate`** to 5.4.9.
...
Breaking Changes:
- Updated **`Castle.Services.Transaction`** to 5.1.0.
- Updated **`Castle.Facilities.AutoTx`** to 5.1.0.
- Updated **`NHibernate`** to 5.3.10.
...
- Changed the default `SessionStore` in `NHibernateFacility` from `LogicalCallContextSessionStore` to `AsyncLocalSessionStore`.
...
Breaking Changes:
- Updated **`NHibernate`** to 4.0.0 GA and 3.3.4 GA.
...
- Updated **`Castle.Services.Transaction`** to 3.3.0.
- Updated **`Castle.Facilities.AutoTx`** to 3.3.0.
